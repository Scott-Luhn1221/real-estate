...
public class AgentService {
	...
	public Agent findAgentLogin(String email, String password) {
		return agentRepository.loginAgent(email, password);
	}
	public Optional<Agent> getAgentById(String email) {
		return agentRepository.findById(email);
	}
